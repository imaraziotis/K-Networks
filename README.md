...
## K-Networks (K-Nets)
K-Networks is a scalable exemplar-based clustering algorithm ([see also](https://users.iit.demokritos.gr/~imaraziotis/knets/index.html)). Its operation is composed of three phases. In the first two, the number of exemplars is determined and we have an initial partition while the last is a fine tuning phase.
